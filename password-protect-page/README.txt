...
* [BugFix] Fixed authorization issues where several settings-update actions and the sitewide redirect and password-migration processes could be triggered without properly verifying the user's permission level.
* [Improvement] Strengthened capability checks and access validation across the plugin following a full security review.

= 1.9.23 =

* [Compatibility] Confirmed compatibility with WordPress 7.1 and tested the plugin with the latest WordPress version to ensure continued compatibility and stability.

= 1.9.22 =

* [BugFix] Escaped placeholder and button label attributes in the [ppwp] shortcode's password form to prevent HTML/attribute breakout.
...
* [BugFix] Fixed an authorization issue related to password protection settings for posts and pages.
* [BugFix] Improved capability checks and access validation when managing protected content.
...
* [BugFix] Resolved an issue where the plugin name was not displaying correctly in the deactivation modal.
